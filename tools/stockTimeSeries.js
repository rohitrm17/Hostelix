function showCompany(companyName) {
    document.querySelector('.textBox').value = companyName;
}

let companyDropdown = document.querySelector('.company-dropdown');
companyDropdown.addEventListener("click", () => {
    companyDropdown.classList.toggle('company-active');
});

// getting stock detatils
var api = "HTXOZVCJXZ5HEC4X"; // get your own api (https://www.alphavantage.co/support/#api-key)
var dps = [];
var company = null;
var symbol = null;
var chart = null;
...
function getCompanyData() {
    ...
    company = document.querySelector('.textBox').value;
    let r = company.split("(");
